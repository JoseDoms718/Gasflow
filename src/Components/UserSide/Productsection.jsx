    ...
    const fetchProducts = async () => {
      try {
        ...
        const formatted = (dataToUse || []).map((p) => {
          ...
          return { ...p, image_url: imageUrl, seller };
        });
        ...
        {p.placeholder ? (
          ...
          <>
            ...
            <div className="flex items-start justify-between mt-auto mb-2">
              <div className="flex flex-col text-gray-500 text-sm">
                ...
                <div className="flex items-center gap-1 mt-1">
                  ...
                  <span>
                    {p.seller.barangay}, {p.seller.municipality}
                  </span>
                </div>
              </div>
            ...
            <button
              ...
              className="mt-3 w-full py-2 rounded-md transition bg-blue-600 text-white hover:bg-blue-700"
            >
              Buy Now
            </button>
          </>
        ...
        <div className="relative">
          ...
          >
            {displayProducts.map((p, i) => (
              <SwiperSlide key={i}>{renderCard(p)}</SwiperSlide>
            ))}
          </Swiper>
